    ...
    a.Editable.prototype.coreInit = function () {
        ...
        if (a.options.key !== !1) {
            var d = function (a, b, c) {
                ...
                return document.cookie = d + "=;expires=Thu, 01 Jan 2970 00:00:01 GMT;domain=" + b + ";", b
            }(), j = function () {
                var b = g(a.options.key) || "";
                return b !== g("eQZMe1NJGC1HTMVANU==") && b.indexOf(i, b.length - i.length) < 0 && [g("9qqG-7amjlwq=="), g("KA3B3C2A6D1D5H5H1A3==")].indexOf(i) < 0 ? (a.$box.append(), a.$lb = a.$box.find("> div:last"), a.$ab = a.$lb.find("> a"), h(a.$lb) || h(a.$ab)) : void 0
            };
            j()
        }
